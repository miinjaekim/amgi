...
const translations = {
  English: {
    ...
    practiceIncludeNotDue: 'Include tables that are not due yet',
    practiceStart: 'Start',
    practiceStop: 'Stop',
    ...
    verbsReference: 'Pick a tense to see it. Saving adds it to practice.',
    verbsSave: 'Save',
    verbsSaved: 'Saved',
    verbsSavedCount: '{saved} of {total} saved',
  ...
  Korean: {
    ...
    practiceIncludeNotDue: '아직 복습 차례가 아닌 표도 포함하기',
    practiceStart: '시작',
    practiceStop: '그만하기',
    practiceDoneTitle: '오늘은 여기까지!',
    practiceDoneBody: '복습할 표를 모두 끝냈어요.',
    ...
    verbsReference: '시제를 고르면 표가 보여요. 저장하면 연습에 들어가요.',
    verbsSave: '저장',
    verbsSaved: '저장됨',
    verbsSavedCount: '{total}개 중 {saved}개 저장',
    verbsTitle: '연습 범위',
