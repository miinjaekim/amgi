...
const translations = {
  English: {
    ...
    munliToolWriting: 'Writing',
    munliToolWritingBlurb: 'Write a passage; see how a native would put it.',
    munliToolConjugation: 'Conjugation',
    munliToolConjugationBlurb: 'Type the form. One verb, one tense, one person.',
    ...
    conjugationFillDue: 'Fill in the forms that are due.',
    conjugationNotDue: 'Not due yet',
    ...
    munliProgressPractised: 'forms started',
    munliProgressDue: 'due now',
    munliProgressForms: 'forms in all',
    ...
    // The Practice tab: a picker, a setup screen, then a session that ends.
    // Mirrors Review, whose wording these follow deliberately.
    munliTabPractice: 'Practice',
    ...
    practiceDoneBody: 'You went through everything that was due.',
    practiceStoppedTitle: 'Stopped.',
    practiceCount: '{done} of {total}',
    ...
    // Munli's answer to Cards: what you have saved to practise, and where you
    // curate it. Topics is the catalogue; this is where something leaves the
    ...
    verbsSave: 'Save {tense}',
    verbsSaved: '{tense} saved',
    verbsFilterVerb: 'Verb',
    verbsSaveHint: 'Tap a tense to add it to practice.',
    verbsTitle: 'Practice set',
    verbsIntro: 'Read any table here. Save the ones you want to practise.',
    irregularIntro: 'Verbs that follow no rule, so each one is its own table.',
    verbsFilterTenses: 'Tenses',
    verbsFilterGroups: 'Verb groups',
    verbsFilterAllGroups: 'all groups',
    ...
    settingsPronunciationSpeedDesc: 'Words covers terms and translations. Sentences covers example sentences and native versions in Writing.',
    speedKindTerm: 'Words',
    speedKindSentence: 'Sentences',
    speedSlow: 'Slow',
    speedNormal: 'Normal',
    speedFast: 'Fast',
    ...
    deleteAccountExportHint: 'Want a copy of your cards first? Export them under Your data before deleting.',
    ...
    // Export, in Settings → Your data. The scope is said once, in
    // `settingsExportCardsDesc`, so the two format buttons stay bare.
    cardsExportCSV: 'CSV',
    cardsExportAnki: 'Anki (.txt)',
    settingsExportCards: 'Export your cards',
    settingsExportCardsDesc: 'Every card in every language, archived ones included.',
    settingsExportFailed: 'Export failed. Try again.',
    ...
    // Packs a learner makes — the set questions, the subtopic picker, and the
    // pack once it exists. The Korean side needs the user's approval.
    decksMakePack: 'Make a pack',
    makePackTitle: 'Make a pack',
    makePackIntro: 'Say what the words are for. Amgi finds them in real sources (dictionaries, word lists, texts) and keeps where each one came from.',
    makePackPurpose: 'What is this pack for?',
    makePackPurposeGoal: 'A goal',
    makePackPurposeGoalHint: 'e.g. a TOEIC score',
    makePackPurposeStruggle: 'Something I keep getting stuck on',
    makePackPurposeStruggleHint: 'e.g. idioms in meetings',
    makePackPurposeSituation: "A situation I'm facing",
    makePackPurposeSituationHint: 'e.g. moving to Buenos Aires',
    makePackAbout: 'Say a bit more',
    makePackUsage: 'Where will you use these words?',
    makePackMaterial: 'Anything to work from? (optional)',
    makePackMaterialHint: 'Paste a syllabus, an email, a list. Words found in it are credited to it.',
    makePackFocus: 'Anything to focus on or leave out? (optional)',
    makePackSuggest: 'Suggest parts',
    makePackSuggesting: 'Working out the parts…',
    makePackPartsTitle: 'Pick the parts',
    makePackPartsIntro: 'Each part becomes its own subpack. Finding the words takes a few minutes, so only the parts you tick are searched.',
    makePackPartWords: '~{count} words',
    makePackAddPart: 'Add a part of your own',
    makePackAddPartPlaceholder: 'e.g. Talking to a landlord',
    makePackAdd: 'Add',
    makePackCreate: 'Find the words',
    makePackCreating: 'Starting…',
    makePackBack: 'Back',
    makePackError: 'Something went wrong. Try again.',
    makePackSignIn: 'Sign in to make a pack.',
    userPackMaking: 'Finding words… {ready} of {total} parts done',
    userPackReady: '"{name}" is ready',
    userPackOpen: 'Open',
    userPackDismiss: 'Dismiss',
    userPackLabel: 'Made by you. Words were found in sources, not reviewed by Amgi.',
    userPackPartPending: 'Still finding words for "{name}"…',
    userPackPartFailed: 'Found nothing for "{name}".',
    userPackRetry: 'Try again',
    userPackDelete: 'Delete this pack',
  ...
  Korean: {
    ...
    settingsPronunciationSpeedDesc: '단어는 단어와 번역에, 문장은 예문과 원어민 표현에 적용됩니다.',
    speedKindTerm: '단어',
    speedKindSentence: '문장',
    speedSlow: '느리게',
    speedNormal: '보통',
    speedFast: '빠르게',
    ...
    deleteAccountExportHint: '카드를 먼저 저장해 두고 싶다면, 삭제하기 전에 내 데이터에서 내보낼 수 있어요.',
    ...
    munliProgressPractised: '시작한 형태',
    munliProgressDue: '복습할 형태',
    munliProgressForms: '전체 형태',
    ...
    practiceDoneBody: '복습할 형태를 모두 끝냈어요.',
    practiceStoppedTitle: '연습을 멈췄어요.',
    practiceCount: '{total}개 중 {done}개',
    ...
    verbsSave: '{tense} 저장하기',
    verbsSaved: '{tense} 저장됨',
    verbsFilterVerb: '동사',
    verbsSaveHint: '시제를 누르면 연습에 추가돼요.',
    verbsTitle: '연습 범위',
    verbsIntro: '어떤 표든 여기서 볼 수 있어요. 연습하고 싶은 것만 저장하세요.',
    irregularIntro: '규칙을 따르지 않는 동사예요. 하나하나가 따로 외워야 하는 표예요.',
    verbsFilterTenses: '시제',
    verbsFilterGroups: '동사 유형',
    verbsFilterAllGroups: '전체 유형',
    ...
    cardsExportCSV: 'CSV',
    cardsExportAnki: 'Anki (.txt)',
    settingsExportCards: '카드 내보내기',
    settingsExportCardsDesc: '모든 언어의 카드를, 보관한 카드까지 전부 내보내요.',
    settingsExportFailed: '내보내지 못했어요. 다시 시도해 주세요.',
    // Learn page — word packs + generation
    packsLink: '단어팩 둘러보기',
    ...
    decksMakePack: '단어팩 만들기',
    makePackTitle: '단어팩 만들기',
    makePackIntro: '어디에 쓸 단어인지 알려 주세요. Amgi가 사전, 단어 목록, 실제 글 같은 출처에서 단어를 찾고, 단어마다 어디서 찾았는지 남겨 둬요.',
    makePackPurpose: '어떤 단어팩인가요?',
    makePackPurposeGoal: '이루고 싶은 목표',
    makePackPurposeGoalHint: '예: 토익 점수',
    makePackPurposeStruggle: '자꾸 막히는 부분',
    makePackPurposeStruggleHint: '예: 회의에서 나오는 관용 표현',
    makePackPurposeSituation: '앞두고 있는 상황',
    makePackPurposeSituationHint: '예: 부에노스아이레스로 이사',
    makePackAbout: '조금 더 자세히 알려 주세요',
    makePackUsage: '이 단어들을 어디에서 쓰게 되나요?',
    makePackMaterial: '참고할 자료가 있나요? (선택)',
    makePackMaterialHint: '강의 계획서, 이메일, 단어 목록 등을 붙여 넣으세요. 여기서 찾은 단어는 이 자료를 출처로 남겨요.',
    makePackFocus: '특히 넣거나 빼고 싶은 게 있나요? (선택)',
    makePackSuggest: '구성 제안받기',
    makePackSuggesting: '구성을 짜는 중…',
    makePackPartsTitle: '넣을 부분을 고르세요',
    makePackPartsIntro: '고른 부분은 각각 하위 단어팩이 돼요. 단어를 찾는 데 몇 분 걸려서, 체크한 부분만 찾아요.',
    makePackPartWords: '약 {count}개',
    makePackAddPart: '직접 추가하기',
    makePackAddPartPlaceholder: '예: 집주인과 대화하기',
    makePackAdd: '추가',
    makePackCreate: '단어 찾기',
    makePackCreating: '시작하는 중…',
    makePackBack: '이전',
    makePackError: '문제가 생겼어요. 다시 시도해 주세요.',
    makePackSignIn: '단어팩을 만들려면 로그인하세요.',
    userPackMaking: '단어를 찾는 중… {total}개 중 {ready}개 완료',
    userPackReady: '"{name}" 단어팩이 준비됐어요',
    userPackOpen: '열기',
    userPackDismiss: '닫기',
    userPackLabel: '내가 만든 단어팩이에요. 출처에서 찾은 단어이고, Amgi가 검토하지는 않았어요.',
    userPackPartPending: '"{name}" 단어를 찾는 중…',
    userPackPartFailed: '"{name}"에서 단어를 찾지 못했어요.',
    userPackRetry: '다시 시도',
    userPackDelete: '단어팩 삭제',
