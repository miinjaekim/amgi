...
const translations = {
  English: {
    ...
    conjugationAllCaught: 'Nothing due. Practise anyway?',
    conjugationPractiseAnyway: 'Practise anyway',
  ...
  Korean: {
    ...
    conjugationAllCaught: '복습할 게 없어요. 그래도 연습할까요?',
    conjugationPractiseAnyway: '그래도 연습하기',
