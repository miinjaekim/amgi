...
const translations = {
  English: {
    ...
    // Look up a list — pasted words, each run through the same lookup as
    // Learn. It was "Import" until 2026-09-25, which read as bringing in a file
    // and undersold what it does.
    listLookupOpen: 'Look up a list',
    listLookupTitle: 'Look up a list',
    listLookupPastePrompt: 'Paste words below, one per line.',
    listLookupWordCount: '{count} words',
    listLookupWordCountOne: '1 word',
    listLookupStart: 'Look them up',
    listLookupProcessing: 'Looking up {done}/{total}...',
    listLookupDoneSummary: 'Done — {success} of {total} resolved. {selected} selected.',
    listLookupStatusFailed: 'failed',
    listLookupStatusAmbiguous: 'multiple meanings — skipped',
    listLookupSaving: 'Saving...',
    listLookupSaveCards: 'Save {count} cards',
    listLookupSaveCardsOne: 'Save 1 card',
    listLookupSavedToast: '{count} cards saved.',
    listLookupSavedToastOne: '1 card saved.',
  ...
  Korean: {
    ...
    listLookupOpen: '여러 단어 한꺼번에 찾기',
    listLookupTitle: '여러 단어 한꺼번에 찾기',
    listLookupPastePrompt: '단어를 한 줄에 하나씩 입력하세요.',
    listLookupWordCount: '단어 {count}개',
    listLookupWordCountOne: '단어 1개',
    listLookupStart: '찾기 시작',
    listLookupProcessing: '찾는 중 {done}/{total}...',
    listLookupDoneSummary: '완료 — {total}개 중 {success}개 확인됨, {selected}개 선택됨.',
    listLookupStatusFailed: '실패',
    listLookupStatusAmbiguous: '뜻이 여러 개예요 — 건너뜀',
    listLookupSaving: '저장 중...',
    listLookupSaveCards: '카드 {count}장 저장',
    listLookupSaveCardsOne: '카드 1장 저장',
    listLookupSavedToast: '카드 {count}장이 저장되었습니다.',
    listLookupSavedToastOne: '카드 1장이 저장되었습니다.',
    // Learn page — word packs + generation
    packsLink: '단어팩 둘러보기',
