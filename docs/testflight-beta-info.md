...
native speaker would have written them, with notes on what changed.
...
· 글 첨삭 — 이번 빌드에서 가장 많이 바뀐 부분입니다. 학습 화면 위쪽에서 '글'을 고르고 몇 문장 써
...
· Writing review — the largest change in this build. Pick "Passage" at
