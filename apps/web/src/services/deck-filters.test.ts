...
import { buildDeckFilters, filterCardsByDeck } from '@amgi/core';
...
describe('buildDeckFilters', () => {
  ...
  it('lists Everything and Mine first, then each enrolled pack in registry order', () => {
  ...
  it('counts the rows each chip would show, with grid packs out of Everything', () => {
